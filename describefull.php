...
<div class="container">
  ...
  <div class="row">
   ...
   <a href="describe.php?id=<?php echo $Id; ?>">
       ...
       <img class="img-responsive"  src="upimg/<?php echo htmlentities($Image); ?>" style="height:5.5cm; overflow: hidden;position: relative;border-radius: 5px">
        <div class="overlay">
          <br><br><br>
     ...
     <br>
        ...
        <a href="resume/describe.php?id=<?php echo $Id; ?>"><span  class="btn btn-success">Read More</span>
      </a><br> <br> 
    </div>
  <?php    
