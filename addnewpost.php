   ...
   elseif (strlen($NAME)<3) {
    $_SESSION["ErrorMessage"]="To SHORT Name";
     ...
     exit;
   	   ...
   	   $query1="INSERT INTO portal(datetime,name,age,contact,skills,course,college,image,post,publish_by)
   	    VALUES('$datetime','$NAME','$AGE','$CONTECT','$SKILL','$COURSE','$coll_name','$image','$POST','$userLoggedIn')";
		...
		<div class="col-sm-10"><!--middle div-->
			...
			<div>
				<form action="addnewpost.php" enctype="multipart/form-data" method="post">
                    ...
                    //    $query="SELECT firstname,lastname FROM studentregister where collegename='$user_col'";
                      //   $execute=mysqli_query($Connection,$query);
                        // while($dataRows=mysqli_fetch_array($execute)) {

                //         ?>
						<!--<select class="form-control" name="Name">
							<option><?php //$dataRows['firstname'].$dataRows['lastname'] ?></option>
						</select>-->
						<?php //} ?>
					</div>
					<div class="form-group">
             ...
             <div class="table-responsive">
		  	<table class="table table-striped table-hover">
		  		...
		  		<?php 
                global $ConnectingDB;
                $viewquery="SELECT * FROM portal where publish_by='$userLoggedIn' ORDER BY datetime desc";
